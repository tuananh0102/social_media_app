        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileAcceptId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendships", x => new { x.ProfileRequestId, x.ProfileAcceptId });
                    table.ForeignKey(
                        name: "FK_Friendships_Users_ProfileRequestId",
